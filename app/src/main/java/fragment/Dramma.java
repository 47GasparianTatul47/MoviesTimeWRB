...
public class Dramma extends Fragment implements MovieItemClickLisenter {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_dramma, container, false);

        recyclerView = v.findViewById(R.id.RV_dramma);

        movieListDramma = new ArrayList<>();

        getDatabaseReference = FirebaseDatabase.getInstance().getReference("Drama");

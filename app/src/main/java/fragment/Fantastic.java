...
public class Fantastic extends Fragment implements MovieItemClickLisenter {

    private View v;
    private RecyclerView recyclerView;
    private MovieAdapter movieAdapter;
    List<Movie> movieListDramma;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_fantastic, container, false);

        recyclerView = v.findViewById(R.id.RV_fantastic);

        movieListDramma = new ArrayList<>();

        getDatabaseReference = FirebaseDatabase.getInstance().getReference("Fantastic");
        ...
        getDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    movieListDramma.add(data);
                }

                movieAdapter = new MovieAdapter(movieListDramma, getActivity(), (MovieItemClickLisenter) getActivity());

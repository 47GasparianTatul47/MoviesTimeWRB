...
public class Horror extends Fragment implements MovieItemClickLisenter {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_horror, container, false);

        recyclerView = v.findViewById(R.id.RV_horror);

        movieListDramma = new ArrayList<>();

        getDatabaseReference = FirebaseDatabase.getInstance().getReference("DraHorrorma");

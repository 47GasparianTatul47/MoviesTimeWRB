...
public class Thriller extends Fragment implements MovieItemClickLisenter {

    private View v;
    private RecyclerView recyclerView;
    private MovieAdapter movieAdapter;
    List<Movie> movieListThriller;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_thriller, container, false);


        recyclerView = v.findViewById(R.id.rv_thriller);

        movieListThriller = new ArrayList<>();

        getDatabaseReference = FirebaseDatabase.getInstance().getReference("Triler");
        ...
        getDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    movieListThriller.add(data);
                }

                movieAdapter = new MovieAdapter(movieListThriller, getActivity(), (MovieItemClickLisenter) getActivity());
